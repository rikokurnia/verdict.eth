...
export const DEMO_ASSETS: DemoAsset[] = [
  {
    ...
    underlying: 'U.S. Treasury Bills, Repurchase Agreements, & Cash',
    tokenStandard: 'ERC-3643 (Permissioned)',
    investorEligibility: 'Qualified Purchasers (US 3(c)(7))',
    custodian: 'BNY Mellon',
    fundAdmin: 'Securitize LLC',
    auditor: 'PricewaterhouseCoopers (PwC)',
    officialDocsUrl: 'https://securitize.io/invest/blackrock-buidl',
    oracleFeed: 'Chainlink Proof of Reserve',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Short-duration U.S. Treasury Bills & Reverse Repos',
    tokenStandard: 'ERC-20 (Restricted)',
    investorEligibility: 'Accredited & Institutional (Non-US / Reg D)',
    custodian: 'BNY Mellon & Web3 Custody',
    fundAdmin: 'Hashnote Management LLC',
    auditor: 'Ernst & Young',
    officialDocsUrl: 'https://usyc.hashnote.com/',
    oracleFeed: 'Chainlink NAV Feed',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Short-term U.S. Treasuries & Bank Demand Deposits',
    tokenStandard: 'ERC-20 (Transfer-Restricted)',
    investorEligibility: 'Non-US Persons (Reg S)',
    custodian: 'Morgan Stanley & StoneX',
    fundAdmin: 'Ondo Finance Inc.',
    auditor: 'Ankura Trust',
    officialDocsUrl: 'https://ondo.finance/usdy',
    oracleFeed: 'Chainlink & Pyth Price Feed',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Short-term U.S. Government Bond Portfolio & BUIDL',
    tokenStandard: 'ERC-20 (Restricted)',
    investorEligibility: 'Qualified Purchasers (US 3(c)(7))',
    custodian: 'BNY Mellon',
    fundAdmin: 'Ondo Finance Inc.',
    auditor: 'Richey May & Co',
    officialDocsUrl: 'https://ondo.finance/ousg',
    oracleFeed: 'Chainlink NAV Oracle',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: '100% U.S. Government Securities & Repos (FOBXX)',
    tokenStandard: 'Stellar Asset / ERC-20',
    investorEligibility: 'US & Global Investors (SEC 1940 Act)',
    custodian: 'BNY Mellon',
    fundAdmin: 'Franklin Templeton',
    auditor: 'PricewaterhouseCoopers (PwC)',
    officialDocsUrl: 'https://digitalassets.franklintempleton.com/benji/',
    oracleFeed: 'Daily Onchain Share Record',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Short-duration U.S. Government Securities',
    tokenStandard: 'ERC-20 (Restricted)',
    investorEligibility: 'Qualified Purchasers & QIBs',
    custodian: 'BNY Mellon',
    fundAdmin: 'Superstate Inc.',
    auditor: 'Ernst & Young',
    officialDocsUrl: 'https://superstate.co/',
    oracleFeed: 'Chainlink Proof of Reserve',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Short-term U.S. Treasury Bills (LTF)',
    tokenStandard: 'Centrifuge Pool Token / ERC-20',
    investorEligibility: 'Accredited / Professional Investors (BVI SPV)',
    custodian: 'BNY Mellon',
    fundAdmin: 'Centrifuge Network',
    auditor: 'Grant Thornton',
    officialDocsUrl: 'https://centrifuge.io/',
    oracleFeed: 'Centrifuge NAV Oracle',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'European Sovereign T-Bills (France/Germany/Italy)',
    tokenStandard: 'ERC-20 (EU Regulated)',
    investorEligibility: 'Eligible European & Global Investors',
    custodian: 'CACEIS Bank (Crédit Agricole)',
    fundAdmin: 'Spiko SAS',
    auditor: 'Deloitte',
    officialDocsUrl: 'https://www.spiko.xyz/',
    oracleFeed: 'Onchain NAV Feed',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Euro Overnight Money Market Assets (Amundi)',
    tokenStandard: 'ERC-20 (EU Regulated)',
    investorEligibility: 'Eligible European Corporate & Institutional',
    custodian: 'CACEIS Bank (Crédit Agricole)',
    fundAdmin: 'Spiko / Amundi',
    auditor: 'Deloitte',
    officialDocsUrl: 'https://www.spiko.xyz/',
    oracleFeed: 'Onchain NAV Feed',
  },
  {
    ...
    tokenStandard: 'Centrifuge Pool Token / ERC-20',
    investorEligibility: 'Qualified Institutional Purchasers',
    custodian: 'BNY Mellon',
    fundAdmin: 'Centrifuge Network',
    auditor: 'Grant Thornton',
    officialDocsUrl: 'https://centrifuge.io/',
  ...
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Prime Home Equity Lines of Credit & Cash',
    tokenStandard: 'Provenance Native Marker',
    investorEligibility: 'SEC Registered / Accredited Investors',
    custodian: 'Figure Trust Company',
    fundAdmin: 'Figure Markets Inc.',
    auditor: 'KPMG',
    officialDocsUrl: 'https://figure.com/',
    oracleFeed: 'Provenance Daily Settlement Oracle',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Allocated London Good Delivery Physical Gold Bullion',
    tokenStandard: 'ERC-20',
    investorEligibility: 'Global Public (KYC for Physical Redemption)',
    custodian: 'Tether Gold Vaults (Switzerland)',
    fundAdmin: 'TG Commodities Limited',
    auditor: 'BDO Italia',
    officialDocsUrl: 'https://gold.tether.to/',
    oracleFeed: 'Chainlink Gold PoR & Price Feed',
  },
  {
    ...
    snapshot: 'Allocated-gold backing · per-ounce pricing', snapshotAsOf: LIVE,
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: '1:1 Allocated London Good Delivery 400oz Gold Bars',
    tokenStandard: 'ERC-20 (NYDFS Regulated)',
    investorEligibility: 'Global Retail & Institutional (KYC for Redemption)',
    custodian: 'Brink’s Vaults (London)',
    fundAdmin: 'Paxos Trust Company LLC',
    auditor: 'WithumSmith+Brown',
    officialDocsUrl: 'https://paxos.com/paxg/',
    oracleFeed: 'Chainlink PAXG / USD Price & PoR Feed',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Allocated 999.9 Fine Physical Gold Bullion',
    tokenStandard: 'ERC-20 (Kinesis Monetary System)',
    investorEligibility: 'Global Account Holders',
    custodian: 'Kinesis Allocated Bullion Vaults',
    fundAdmin: 'Kinesis Cayman',
    auditor: 'Inspectorate (Bureau Veritas)',
    officialDocsUrl: 'https://kinesis.money/',
    oracleFeed: 'Kinesis Exchange Oracle',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: '1:1 Collateralized NVIDIA (NVDA) Common Stock',
    tokenStandard: 'ERC-20 Tracker Certificate',
    investorEligibility: 'Non-US Qualified Investors (Swiss DLT Act)',
    custodian: 'Maerki Baumann & Co. AG',
    fundAdmin: 'Backed Finance AG',
    auditor: 'Grant Thornton Switzerland',
    officialDocsUrl: 'https://xstocks.fi/',
    oracleFeed: 'Chainlink Tokenized Stock Feed',
  },
  {
    ...
    snapshot: 'Tokenized equity exposure · 1:1 collateralized tracker', snapshotAsOf: LIVE,
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: '1:1 Collateralized Tesla (TSLA) Common Stock',
    tokenStandard: 'ERC-20 Tracker Certificate',
    investorEligibility: 'Non-US Qualified Investors (Swiss DLT Act)',
    custodian: 'Maerki Baumann & Co. AG',
    fundAdmin: 'Backed Finance AG',
  ...
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Institutional Senior Secured Private Credit Loans',
    tokenStandard: 'ERC-20',
    investorEligibility: 'Accredited & KYC-Approved Lenders',
    custodian: 'BitGo & Fireblocks Escrow',
    fundAdmin: 'Maple Direct LLC',
    auditor: 'Spearbit & Certora',
    officialDocsUrl: 'https://maple.finance/',
    oracleFeed: 'Maple Onchain Pool Contracts',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Senior Home Equity Lines of Credit Portfolio',
    tokenStandard: 'Provenance Smart Contract Token',
    investorEligibility: 'Institutional Credit Buyers',
    custodian: 'Figure Lending LLC',
    fundAdmin: 'Figure Technologies',
    auditor: 'KPMG',
    officialDocsUrl: 'https://figure.com/',
    oracleFeed: 'Provenance Market Oracle',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Blockchain Capital Venture Fund LP Interests',
    tokenStandard: 'ERC-20 Security Token',
    investorEligibility: 'Accredited Investors & Qualified Purchasers',
    custodian: 'Securitize Escrow Services',
    fundAdmin: 'Blockchain Capital LLC',
    auditor: 'Top-tier U.S. Fund Auditor',
    officialDocsUrl: 'https://blockchain.capital/',
    oracleFeed: 'Quarterly Audited NAV Feed',
  },
  {
    ...
    auditNote: ISSUER_LINKED, riskNote: NO_POLICY, heartbeat: 'Market feed',
    underlying: 'Reinsurance Collateral & Underwriting Reserves',
    tokenStandard: 'Solana SPL Token',
    investorEligibility: 'Qualified Reinsurance Underwriters',
    custodian: 'Regulated Bermuda Trust',
    fundAdmin: 'OnRe Protocols Inc.',
    auditor: 'Bermuda Monetary Authority Regulated',
    officialDocsUrl: 'https://www.coingecko.com/en/coins/onyc',
    oracleFeed: 'Pyth Network Oracle',
  },
  {
